...
const getSecurityTxt = (canonicalURL: URL) => {
  ...
  return `Contact: mailto:security@macosdb.com
Contact: https://github.com/starhaven-io/macOSdb/security/advisories/new
Expires: ${expires.toISOString()}
Preferred-Languages: en
Canonical: ${canonicalURL.href}
Policy: https://github.com/starhaven-io/macOSdb/security/policy
`;
};
