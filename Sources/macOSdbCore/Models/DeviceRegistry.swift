...
enum DeviceRegistry {
    ...
    static func chip(for model: String) -> ChipFamily? {
        allDevices[model]?.chip
    }

    static func info(for model: String) -> DeviceInfo? {
        allDevices[model]
    }
    ...
    static let allDevices: [String: DeviceInfo] = { // swiftlint:disable:this closure_body_length
        let entries: [DeviceInfo] = [
            // MARK: M1 (Late 2020 – Mid 2021)
            DeviceInfo(model: "MacBookAir10,1", chip: .m1,
                       marketingName: "MacBook Air (M1, Late 2020)"),
            DeviceInfo(model: "MacBookPro17,1", chip: .m1,
                       marketingName: "MacBook Pro (13-inch, M1, Late 2020)"),
            ...
            DeviceInfo(model: "MacBookPro18,1", chip: .m1Pro,
                       marketingName: "MacBook Pro (16-inch, M1 Pro, Late 2021)"),
            DeviceInfo(model: "MacBookPro18,3", chip: .m1Pro,
                       marketingName: "MacBook Pro (14-inch, M1 Pro, Late 2021)"),

            // MARK: M1 Max (Late 2021 – 2022)
            DeviceInfo(model: "MacBookPro18,2", chip: .m1Max,
                       marketingName: "MacBook Pro (16-inch, M1 Max, Late 2021)"),
            DeviceInfo(model: "MacBookPro18,4", chip: .m1Max,
                       marketingName: "MacBook Pro (14-inch, M1 Max, Late 2021)"),
            DeviceInfo(model: "Mac13,1", chip: .m1Max,
                       marketingName: "Mac Studio (M1 Max, 2022)"),

            // MARK: M1 Ultra (2022)
            DeviceInfo(model: "Mac13,2", chip: .m1Ultra,
                       marketingName: "Mac Studio (M1 Ultra, 2022)"),
            ...
            DeviceInfo(model: "Mac14,9", chip: .m2Pro,
                       marketingName: "MacBook Pro (14-inch, M2 Pro, 2023)"),
            DeviceInfo(model: "Mac14,10", chip: .m2Pro,
                       marketingName: "MacBook Pro (16-inch, M2 Pro, 2023)"),
            DeviceInfo(model: "Mac14,12", chip: .m2Pro,
                       marketingName: "Mac mini (M2 Pro, 2023)"),

            // MARK: M2 Max (2023)
            DeviceInfo(model: "Mac14,5", chip: .m2Max,
                       marketingName: "MacBook Pro (14-inch, M2 Max, 2023)"),
            DeviceInfo(model: "Mac14,6", chip: .m2Max,
                       marketingName: "MacBook Pro (16-inch, M2 Max, 2023)"),
            DeviceInfo(model: "Mac14,13", chip: .m2Max,
                       marketingName: "Mac Studio (M2 Max, 2023)"),

            // MARK: M2 Ultra (2023)
            DeviceInfo(model: "Mac14,14", chip: .m2Ultra,
                       marketingName: "Mac Studio (M2 Ultra, 2023)"),
            DeviceInfo(model: "Mac14,8", chip: .m2Ultra,
                       marketingName: "Mac Pro (M2 Ultra, 2023)"),

            // MARK: M3 (Late 2023 – 2024)
            DeviceInfo(model: "Mac15,3", chip: .m3,
                       marketingName: "MacBook Pro (14-inch, M3, Late 2023)"),
            DeviceInfo(model: "Mac15,4", chip: .m3,
                       marketingName: "iMac (24-inch, M3, 2023) 2-port"),
            DeviceInfo(model: "Mac15,5", chip: .m3,
                       marketingName: "iMac (24-inch, M3, 2023) 4-port"),
            ...
            DeviceInfo(model: "Mac15,6", chip: .m3Pro,
                       marketingName: "MacBook Pro (14-inch, M3 Pro, Late 2023)"),
            DeviceInfo(model: "Mac15,7", chip: .m3Pro,
                       marketingName: "MacBook Pro (16-inch, M3 Pro, Late 2023)"),

            // MARK: M3 Max (Late 2023)
            DeviceInfo(model: "Mac15,8", chip: .m3Max,
                       marketingName: "MacBook Pro (14-inch, M3 Max, Late 2023)"),
            DeviceInfo(model: "Mac15,9", chip: .m3Max,
                       marketingName: "MacBook Pro (16-inch, M3 Max, Late 2023)"),
            ...
            DeviceInfo(model: "Mac15,14", chip: .m3Ultra,
                       marketingName: "Mac Studio (M3 Ultra, 2025)"),

            // MARK: M4 (Late 2024 – 2025)
            DeviceInfo(model: "Mac16,1", chip: .m4,
                       marketingName: "MacBook Pro (14-inch, M4, Late 2024)"),
            DeviceInfo(model: "Mac16,2", chip: .m4,
                       marketingName: "iMac (24-inch, M4, 2024) 2-port"),
            DeviceInfo(model: "Mac16,3", chip: .m4,
                       marketingName: "iMac (24-inch, M4, 2024) 4-port"),
            DeviceInfo(model: "Mac16,10", chip: .m4,
                       marketingName: "Mac mini (M4, 2024)"),
            DeviceInfo(model: "Mac16,12", chip: .m4,
                       marketingName: "MacBook Air (13-inch, M4, 2025)"),
            DeviceInfo(model: "Mac16,13", chip: .m4,
                       marketingName: "MacBook Air (15-inch, M4, 2025)"),

            // MARK: M4 Pro (Late 2024)
            DeviceInfo(model: "Mac16,7", chip: .m4Pro,
                       marketingName: "MacBook Pro (16-inch, M4 Pro, Late 2024)"),
            DeviceInfo(model: "Mac16,8", chip: .m4Pro,
                       marketingName: "MacBook Pro (14-inch, M4 Pro, Late 2024)"),
            DeviceInfo(model: "Mac16,11", chip: .m4Pro,
                       marketingName: "Mac mini (M4 Pro, 2024)"),

            // MARK: M4 Max (Late 2024 – 2025)
            DeviceInfo(model: "Mac16,5", chip: .m4Max,
                       marketingName: "MacBook Pro (16-inch, M4 Max, Late 2024)"),
            DeviceInfo(model: "Mac16,6", chip: .m4Max,
                       marketingName: "MacBook Pro (14-inch, M4 Max, Late 2024)"),
            DeviceInfo(model: "Mac16,9", chip: .m4Max,
                       marketingName: "Mac Studio (M4 Max, 2025)"),

            // MARK: M5 (2025–2026)
            DeviceInfo(model: "Mac17,2", chip: .m5,
                       marketingName: "MacBook Pro (14-inch, M5, 2025)"),
            DeviceInfo(model: "Mac17,3", chip: .m5,
                       marketingName: "MacBook Air (13-inch, M5, 2026)"),
            DeviceInfo(model: "Mac17,4", chip: .m5,
                       marketingName: "MacBook Air (15-inch, M5, 2026)"),

            // MARK: M5 Pro (2026)
            DeviceInfo(model: "Mac17,6", chip: .m5Pro,
                       marketingName: "MacBook Pro (16-inch, M5 Pro, 2026)"),
            DeviceInfo(model: "Mac17,7", chip: .m5Pro,
                       marketingName: "MacBook Pro (14-inch, M5 Pro, 2026)"),

            // MARK: M5 Max (2026)
            DeviceInfo(model: "Mac17,8", chip: .m5Max,
                       marketingName: "MacBook Pro (16-inch, M5 Max, 2026)"),
            DeviceInfo(model: "Mac17,9", chip: .m5Max,
                       marketingName: "MacBook Pro (14-inch, M5 Max, 2026)"),

            // MARK: A18 Pro (2026)
            DeviceInfo(model: "Mac17,5", chip: .a18Pro,
                       marketingName: "MacBook Neo (13-inch, 2026)"),
